...
@Component({
  ...
  template: `
    <div
      [class]="widgetLayoutNode?.arrayItem && widgetLayoutNode?.type !== '$ref' ? 'array-item ui segment' : 'ui form'"
...
export class SemanticUIFrameworkComponent implements OnInit, OnChanges {
